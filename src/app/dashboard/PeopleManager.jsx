...
const growGuideProductRules = [
  ...
  { label: "Orange / ortanique grow guide", terms: ["orange", "ortanique", "citrus", "fruit tree"] },
  { label: "Lychee grow guide", terms: ["lychee"] },
  { label: "Wax apple grow guide", terms: ["wax apple", "wax jambu", "red wax apple"] },
...
const growGuideLibraryOptions = [
  ...
  { slug: "orange-ortanique-grow-guide", path: "/orange-ortanique", label: "Orange / ortanique grow guide", productTitle: "Orange / ortanique citrus tree" },
  { slug: "lychee-grow-guide", path: "/lychee", label: "Lychee grow guide", productTitle: "Lychee tree" },
  { slug: "wax-apple-grow-guide", path: "/wax-apple", label: "Wax apple grow guide", productTitle: "Wax apple / wax jambu tree" },
