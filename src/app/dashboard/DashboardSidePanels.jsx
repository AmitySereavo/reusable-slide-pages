...
const adminLinks = [
  ...
  { href: "/dashboard/upcoming-propagation", label: "Upcoming Propagation" },
  { href: "/dashboard/upcoming-transplant", label: "Upcoming Transplant" },
  { href: "/dashboard/plant-production-timeline", label: "Plant Production Timeline" },
